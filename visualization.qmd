...
Students are required to draft a short report around the chart, containing the most important information of chart creation and some economic policy background. **The final version of the report is due on June 30, 2023.** You should work with [RMarkdown](https://rmarkdown.rstudio.com/index.html) (or [Quarto](https://quarto.org)) which is a handy and simple tool to compose reports based on R code. It is recommended to edit the document in [RStudio](https://posit.co) and compile it as HTML file. The final report should be structured as follows:
